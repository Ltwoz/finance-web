            ...
            <div className="col-12 col-lg-6">
              <div className="row justify-content-xl-center">
                <div className="col-12 col-xl-11">
                  ...
                  <p className="lead fs-4 text-secondary mb-5">Thank you for visiting us. We value your feedback and inquiries. Please feel free to reach out to us using any of the methods below</p>
                  <div className="d-flex mb-5">
                    ...
                    <div>
                      ...
                      <address className="mb-0 text-secondary">21 Mueang, Chiang Mai</address>
                    </div>
                  </div>
                    ...
                    <div className="col-12 col-sm-6">
                      <div className="d-flex mb-5 mb-sm-0">
                        ...
                        <div>
                          ...
                          <p className="mb-0">
                            <a className="link-secondary text-decoration-none" href="tel:+15057922430">(66)81-123-4567</a>
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="col-12 col-sm-6">
                      <div className="d-flex mb-0">
                        ...
                        <div>
                          ...
                          <p className="mb-0">
                            <a className="link-secondary text-decoration-none" href="mailto:contact@bootbrains.com">financial@warrapat.com</a>
                          </p>
                        </div>
                      </div>
                    </div>
